    ...
    <Layout>
      <div className="container py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-8">About  ThePetWala</h1>
          
          <div className="prose dark:prose-invert max-w-none">
            <p className="text-lg mb-6 text-muted-foreground">
               ThePetWala is the premier platform for connecting pets with loving homes. Whether you're looking to adopt, buy, sell, or breed, we've got you covered.
            </p>
            ...
            <p className="mb-6">
              At  ThePetWala, our mission is to create happy matches between pets and their perfect humans. We believe every pet deserves a loving home, and every pet lover deserves to find their ideal companion.
            </p>
            
            <h2 className="text-2xl font-semibold mb-4">Our Story</h2>
            <p className="mb-6">
              Founded in 2023 by a group of passionate pet lovers,  ThePetWala was born out of frustration with the fragmented pet marketplace. We wanted to create a single platform where adoption, sales, and breeding services could all exist in harmony, with the welfare of animals always at the center.
            </p>
            ...
            <p className="mb-6">
              Our dedicated team comprises animal experts, technology enthusiasts, and business professionals who share a love for pets. Together, we work tirelessly to make  ThePetWala the best platform for all your pet-related needs.
            </p>
